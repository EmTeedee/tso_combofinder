...
TSOFinder::event_data TSOFinder::get_events()
{
    int eventcount = 8;
    ...
    events[2].caption = tr("Christmas 2013/14");
    events[2].id = 2;
    ...
    events[4].caption = tr("Soccer WM 2014");
    events[4].id = 4;
    events[4].itemcount = 8;

    events[5].caption = tr("Halloween 2014/15");
    events[5].id = 5;
    events[5].itemcount = 1;

    events[6].caption = tr("Easter 2015/16");
    events[6].id = 6;
    events[6].itemcount = 1;

    events[7].caption = tr("Soccer EM 2016");
    events[7].id = 7;
